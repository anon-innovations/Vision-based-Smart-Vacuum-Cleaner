...
#Bot's X and Y is written to image
        cv2.putText(frame,str(cx)+" cx, "+str(cy)+" cy",(guiX+20,guiY+20),cv2.FONT_HERSHEY_COMPLEX_SMALL,.7,(255,255,255))        
        
        #Bot's X and Y averages are written to image
        cv2.putText(frame,str(cxAvg)+" cxA, "+str(cyAvg)+" cyA",(guiX+20,guiY+40),cv2.FONT_HERSHEY_COMPLEX_SMALL,.7,(255,255,255))

        #"Ok" is written to the screen if the X&Y are close to X&Y Avg for several iterations.
        cv2.putText(frame,stringXOk,(guiX+20,guiY+60),cv2.FONT_HERSHEY_COMPLEX_SMALL,.7,(255,255,255))
        cv2.putText(frame,stringYOk,(guiX+20,guiY+80),cv2.FONT_HERSHEY_COMPLEX_SMALL,.7,(255,255,255))

        #Print the compass to the frame.
        cv2.putText(frame,"Bot: "+headingDeg+" Deg",(guiX+20,guiY+100),cv2.FONT_HERSHEY_COMPLEX_SMALL,.7,(255,255,255))
        cv2.putText(frame,"Target: "+strTargetDegs+" Deg",(guiX+20,guiY+120),cv2.FONT_HERSHEY_COMPLEX_SMALL,.7,(255,255,255))
